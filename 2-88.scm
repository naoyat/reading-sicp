...
(put 'render 'scheme-number (lambda (x) (list x)))
(define (render p)
  (myprint ((get 'render (type-tag p)) (contents p))))

(put 'minus '(scheme-number) (lambda (p) (- p)))
...
(define d (make-polynomial 'x '((1 1) (0 -1))))
;(define z1 (make-polynomial 'x '((2 1) (1 '(+ y 1)) (0 5))))
(define e (make-polynomial 'x (list '(2 1) 
